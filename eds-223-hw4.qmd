...
ea <- extract(suitable_area, eez, fun = sum, na.rm = TRUE)


# join extracted results back to eez
eez_sf <- st_as_sf(eez) # to have geometry
eez_joined <- eez_sf %>%
  left_join(ea, by = c("rgn_id"= "ID"))
...
## Create a generalizable funciton 
...
# species preferences defined before function
